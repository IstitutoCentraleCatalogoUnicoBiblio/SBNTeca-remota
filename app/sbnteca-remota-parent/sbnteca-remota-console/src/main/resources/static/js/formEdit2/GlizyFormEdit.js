Glizy.oop.declare("glizy.FormEdit", {
    ...
    initialize: function(formId, glizyOpt) {
        ...
        jQuery('.js-glizycms-save-novalidation').click(function (e) {
        ...
        self.$form.validVal({
            ...
            fields: {
                onValidate: function ($form, language) {
                    ...
                    if (obj && !obj.isDisabled() && !obj.isValid()) {
    ...
    save: function (el, enableValidation, $saveButton) {
        ...
        if (this.glizyOpt.AJAXAction.indexOf('event:')===0) {
            window.parent.Glizy.events.broadcast(this.glizyOpt.AJAXAction.substring(6), {action: $(el).data("action"), data: formData});
            $saveButton.removeAttr("disabled");
            return;
        }
