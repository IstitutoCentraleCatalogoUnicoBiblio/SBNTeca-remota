...
$(document).ready(function() {
	...
	$.ajax({
		url: restUrl + "magdata?" + window.location.href.slice(window.location.href.indexOf('?') + 1),
		success: function(jsonRes) {
			$('#containerData').append("<div class=\"help-block row\"></div><div class=\"help-block row\"></div>");
			$("#containerData").append("<div id=\"importSection\" class=\"row-fluid detail-section form-horizontal\"><div class=\"detail-section-header\"><h4>IMPORTAZIONE</h4></div></div>");
			...
			$('#containerData').append("<div class=\"help-block row\"></div><div class=\"help-block row\"></div>");
			$("#containerData").append("<div id=\"genSection\" class=\"row-fluid detail-section form-horizontal\"><div class=\"detail-section-header\"><h4>METADATI GENERALI</h4></div></div>");
			gen = jsonRes.gen;
			...
			$('#containerData').append("<div class=\"help-block row\"></div><div class=\"help-block row\"></div>");
			$("#containerData").append("<div id=\"bibSection\" class=\"row-fluid detail-section form-horizontal\"><div class=\"page-header\"><h4>DATI CATALOGRAFICI</h4></div></div>");
			bib = jsonRes.bib;
			displayValues("bibSection", "magIdentifier", "Identifier", bib.identifier);
			displayValues("bibSection", "magType", "Tipo Documento", bib.tipi);
			displayValue("bibSection", "magLevel", "Livello Bibliografico", bib.livello_bibliografico);
			displayValues("bibSection", "magTitle", "Titolo", bib.titoli);
			...
			if(bib.localizzazione.length > 0) {
				for(var i = 0; i < bib.localizzazione.length; i++) {
					obj = bib.localizzazione[i];
					segnature = "";
					
					if(obj.segnature.length > 0) {
						for(j = 0; j < obj.segnature.length; j++) {
							if(j > 0)
								segnature += " - ";
			...
			if(jsonRes.stru.length > 0) {
				$('#containerData').append("<div class=\"help-block row\"></div><div class=\"help-block row\"></div>");
				$("#containerData").append("<div id=\"struSection\" class=\"row-fluid\">" +
						"<div class=\"detail-section-header\"><h4>STRUTTURA</h4></div><div id=\"stru_tree\" /><div class=\"help-block row\"></div><div class=\"help-block row\"></div></div>");
			...
			for(var i = 0; i < jsonRes.risorse.length; i++) {
			...
			if(dis.dis_item != null && dis.dis_item != undefined && dis.dis_item.length > 0) {
				$('#containerData').append("<div class=\"help-block row\"></div><div class=\"help-block row\"></div>");
