...
/**
 * <p>Classe Java per titleInfoDefinition complex type.
 * 
...
public class TitleInfo implements Serializable
{
    ...
    protected List<Serializable> titlesAndSubTitlesAndPartNumbers;
    @XmlAttribute(name = "type")
    protected String typeTitleInfo;
     ...
     * 
     */
    public List<Serializable> getTitlesAndSubTitlesAndPartNumbers() {
        if (titlesAndSubTitlesAndPartNumbers == null) {
            titlesAndSubTitlesAndPartNumbers = new ArrayList<Serializable>();
        }
        return this.titlesAndSubTitlesAndPartNumbers;
    }

    /**
     * Recupera il valore della proprietà typeTitleInfo.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getTypeTitleInfo() {
        return typeTitleInfo;
    }

    /**
     * Imposta il valore della proprietà typeTitleInfo.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTypeTitleInfo(String value) {
        this.typeTitleInfo = value;
    }
