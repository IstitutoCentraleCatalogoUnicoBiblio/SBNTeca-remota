...
public class SbnMarcClient {
	...
	protected String url = "https://polo/SbnMarcWeb/SbnMarcTest";
	...
	public String getSbnMarc2Mods(MagTransformer magTransformer, String bid) throws MagException {
		try {
			Document document = getResponse(bid);
			return magTransformer.transform(document,"mods");
		}
		catch(Exception e ){
			throw  new MagException(e.getMessage());
		}
